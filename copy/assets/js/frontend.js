...
$(document).ready(async function () {
    // debugger
    $("#new-projects").load("/test/load.html #projects li");

    const head = await fetch('/assets/js/head.html');
    document.querySelector('head').innerHTML = await head.text();

    const header = await fetch('/assets/js/header.html');
    document.querySelector('header').outerHTML = await header.text();

    const footer = await fetch('/assets/js/footer.html');
    document.querySelector('footer').outerHTML = await footer.text();



    // $("head").load("/assets/js/me-index.html head");
    // $("header").load("/assets/js/me-index.html header *");
    // $("footer").load("/assets/js/me-index.html footer .container");
    document.title = "da-1";
