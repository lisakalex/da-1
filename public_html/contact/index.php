                    ...
                    <div class="col-12 col-md-4 offset-xl-1 col-xl-3 align-self-center">
                        <div class="contact-sidebar nowrap">
                            <div class="mb-30">
                                ...
                                <a href="mailto:support@&lt;data class=" replace-1"="" value="">.com" class="d-inline-block"&gt;support@
                                <data class="replace-1" value=""></data>
                                .com</a></div>
                            <div class="mb-30">
                                <div class="d-inline-block">
                                    <data class="replace-2" value=""></data>
                                    LTD <br/>52-60 Tabernacle Street<br/>London<br/>United Kingdom<br/>EC2A 4NJ<br/></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom pt-30 pb-30">
            <div class="row">
                <div class="col-12 col-md-6 text-center text-md-left mb-20 mb-md-0">
                    <div class="fs-12 c-light-grey">© 2023 Cryptonews. All rights reserved</div>
                </div>
