...
//         // document.body.innerHTML = text.replace(/cryptonews/g, siteName);
//         // document.body.innerHTML = text.replace(/Cryptonews/g, siteName);
//         // document.body.innerHTML = text.replace(/CryptoNews/g, siteName);
//         // document.body.innerHTML = text.replace(/CRYPTONEWS/g, siteName);
//         // document.body.innerHTML = text.replace(/Crypto News/g, siteName);
//         // document.body.innerHTML = text.replace(/Cryptonews.com/g, siteName);
//         // document.body.innerHTML = text.replace(/cryptonews.com/g, siteName);
//         //
//         // $(".replace-1").load("Crypto News");
...
//         // const mailto = '<data class="replace-5" value="">Crypto News</data>';
//
//
