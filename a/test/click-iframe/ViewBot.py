...
class ViewBot:
    ...
    def __init__(self, link, port=9150, driver_path=r'/var/www/hyip.com/public_html/test/chromedriver'):
        """
    ...
    def createUniqueBrowser(self):
        ...
        self.browser = webdriver.Chrome(chrome_options=self.options, executable_path="/var/www/hyip.com/public_html/test/chromedriver")
    ...
    def view(self, views):
        ...
        for view in range(1, int(views) + 1):
            ...
            print
            "[{}][START][{}]".format(colored("SYSTEM", "green"), colored("#" + str(view), color))
            self.createUniqueBrowser()
            self.uniqueView()
            print
            "[{}][CLOSE][{}]".format(colored("SYSTEM", "green"), colored("#" + str(view), color))
    ...
    def uniqueView(self):
        ...
        try:
            randomEvents = self.clickLinks, self.scroll, self.searchPhrase, self.sleepRandom
    ...
    def searchPhrase(self):
        ...
        print
        '[{}][ACTION][TYPE]["{}"]'.format(colored("BROWSER", "green"), phrase)
        self.sleepRandom()
    ...
    def sleepRandom(self):
        ...
        sleep = randint(5, 10)
        print
        "[{}][ACTION][SLEEP][{}]".format(colored("SYSTEM", "green"), sleep)
        time.sleep(sleep)
    ...
    def scroll(self):
        ...
        print
        "[{}][ACTION][SCROLL][{}]".format(colored("BROWSER", "green"), scrollDistance)
        scrollY = 0
